...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Department', models.CharField(choices=[('programming', 'PROGRAMMING'), ('electronics', 'ELECTRONICS'), ('business management', 'BUSINESS MANAGEMENT'), ('cyber security', 'CYBER SECURITY')], max_length=30)),
